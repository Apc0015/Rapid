...
class IntelligenceGateway:
    ...
    async def _ask_organization(
        ...
        try:
            ...
            # same class as the builtin TimeoutError from Python 3.11 on —
            # catching the builtin alone silently misses this on 3.9/3.10 and
            # falls through to the generic handler below with the wrong message.
